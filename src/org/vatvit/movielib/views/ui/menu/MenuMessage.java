...
/**
 * Viestien/virheilmoitusten näyttämiseen tarkoitettu näkymä
 *
 */
public class MenuMessage extends View {
	...
	/**
	 * Luo uusi viesti käyttäen parametrinä annettua merkkijonoa.
	 * @param messageContent viesti
	 */
	...
	private void initialize() {
		...
		guide = new JLabel();
		guide.setText(SettingsLoader.getValue("lang.press_esc_to_go_back", "Paina ESC -painiketta palataksesi edelliseen näkymään"));
