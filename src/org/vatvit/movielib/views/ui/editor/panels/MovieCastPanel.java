 ...
 //  @jve:decl-index=0:
		...
		if (castList == null) {
			...
			castList.addListSelectionListener(new ListSelectionListener() {
				...
				public void valueChanged(ListSelectionEvent arg0) {
					...
					MovieCast selectedCast = (MovieCast)castList.getSelectedValue();
	...
	private JPanel getControlsPanel() {
		if (controlsPanel == null) {
			...
			roleOrJobLabel.setText("Rooli/Työ:");
		...
		if (addButton == null) {
			...
			addButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					cast.setJob(actorCheckBox.isSelected()?"Actor":roleOrJobField.getText());
					cast.setRole(actorCheckBox.isSelected()?roleOrJobField.getText():"");
					castData.add(cast);
					castList.revalidate();
					repaint();
				}
		...
		if (editButton == null) {
			...
			editButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					selectedCast.setJob(actorCheckBox.isSelected()?"Actor":roleOrJobField.getText());
					selectedCast.setRole(actorCheckBox.isSelected()?roleOrJobField.getText():"");
					castList.revalidate();
					repaint();
				}
