...
/**
 * Tietokantayhteyden luomiseen käytettävä luokka.
 */
public class DatabaseConnection {
	...
	private static final String[] createTables = new String[] {
			createMovies, createMovieSubtitle,
			createMovieGenres, createMovieCast };

	/**
	 * Luo SQLite tietokanta tiedoston vakiossa DATABASE
	...
	/**
	 * Luo tietokantayhteys sigletonin = yksi yhteys per sovellus
	 * 
	 * @return tietokantayhteys
	 * @throws SQLException
	 * @throws ClassNotFoundException
